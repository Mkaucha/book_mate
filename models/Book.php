...
class Book {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " 
                  ...
                  VALUES (:isbn, :title, :author, :publisher, :category, :publication_year, :total_copies, :available_copies, :description, :cover_image)";
    ...
    // The method you need for the edit form
    public function update($book_id, $data) {
        ...
        $stmt->bindParam(':publication_year', $data['publication_year'], PDO::PARAM_INT);
        $stmt->bindParam(':total_copies', $data['total_copies'], PDO::PARAM_INT);
        $stmt->bindParam(':available_copies', $data['available_copies'], PDO::PARAM_INT);
        $stmt->bindParam(':description', $data['description']);
        $stmt->bindParam(':book_id', $book_id, PDO::PARAM_INT);
        return $stmt->execute();
    }

    // Use this version if you're updating via object properties
    public function updateBook() {
        ...
        $stmt->bindParam(':total_copies', $this->total_copies, PDO::PARAM_INT);
        $stmt->bindParam(':available_copies', $this->available_copies, PDO::PARAM_INT);
        $stmt->bindParam(':description', $this->description);
